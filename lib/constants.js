...
const ERROR_MESSAGES = {
	...
	ROLE_ADD_ERROR: "❌　ロール追加時にエラーが発生しました。お手数ですが、以下のURLからDiscordのIDを添えて管理者までお問い合わせください。\nhttps://forms.gle/E5Pt7YRJfVcz4ZRJ6",
	SELF_INTRODUCTION_ERROR: "❌　自己紹介の登録時にエラーが発生しました。お手数ですが、以下のURLからDiscordのIDを添えて管理者までお問い合わせください。\nhttps://forms.gle/E5Pt7YRJfVcz4ZRJ6",
	SERVER_ONLY: "❌ このBOTはサーバー内でのみ動作します。\nお手数をおかけしますが、サーバー内でご利用ください。",
	ADMIN_ONLY: "このコマンドはBOTの管理者のみ実行可能です。",
	UNIVERSITY_NOT_FOUND: "❌　大学名が見つかりませんでした。もう一度お試しください。",
};
...
const EMBED_TITLES = {
	...
	WAITING_FOR_ADMIN: "サーバー管理者の参加許可を待機中…",
...
const URLS = {
	...
	RULES_DOCUMENT: "https://docs.google.com/document/d/e/2PACX-1vQWDtLH0nCXh8oc1k-NMNeviG5QvvLVjlj0yApHKMCKvaHeBkmqCJxXXiALJ-OEa92z-s8VACL7R6x6/pub",
};
